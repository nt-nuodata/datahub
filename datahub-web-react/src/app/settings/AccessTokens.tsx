...
export const AccessTokens = () => {
    ...
    const onRemoveToken = (token: any) => {
        Modal.confirm({
            ...
            content: `Anyone using this token will no longer be able to access the NuoData API. You cannot undo this action.`,
            onOk() {
    ...
    return (
        <SourceContainer>
            ...
            <TokensContainer>
                <TokensHeaderContainer>
                    ...
                    <Typography.Paragraph type="secondary">
                        Manage Access Tokens for use with NuoData APIs.
                ...
                <StyledAlert
                    ...
                    message={
                        <span>
                            ...
                            Token based authentication is currently disabled. Contact your NuoData administrator to
                            enable this feature.
                        </span>
                    }
                />
            ...
            <PersonTokenDescriptionText type="secondary">
                Personal Access Tokens allow you to make programmatic requests to NuoData&apos;s APIs. They inherit your
