...
export const MYSQL_HOST_PORT: RecipeField = {
    ...
    label: 'Host and Port',
    tooltip:
        "The host and port where Postgres is running. For example, 'localhost:5432'. Note: this host must be accessible on the network where NuoData is running (or allowed via an IP Allow List, AWS PrivateLink, etc).",
    type: FieldType.TEXT,
