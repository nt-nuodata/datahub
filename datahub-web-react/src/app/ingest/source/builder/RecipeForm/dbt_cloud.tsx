...
export const EXTRACT_OWNERS: RecipeField = {
    ...
    tooltip:
        'Try to extract owners from dbt meta properties. Be careful: This can override Owners added by users of NuoData.',
    type: FieldType.BOOLEAN,
...
export const TARGET_PLATFORM_INSTANCE: RecipeField = {
    ...
    tooltip: (
        <span>
            <TipSection>
                The NuoData Platform Instance identifier that should be used for the assets extracted from dbt.
            </TipSection>
            <TipSection>
