...
export const STATEFUL_INGESTION_ENABLED: RecipeField = {
    ...
    tooltip: 'Remove stale assets from NuoData once they have been deleted in the ingestion source.',
    type: FieldType.BOOLEAN,
...
export const INGEST_TAGS: RecipeField = {
    name: 'ingest_tags',
    label: 'Ingest Tags',
    tooltip: 'Ingest Tags from the source. Be careful: This can override Tags entered by users of NuoData.',
    type: FieldType.BOOLEAN,
...
export const INGEST_OWNER: RecipeField = {
    name: 'ingest_owner',
    label: 'Ingest Owner',
    tooltip: 'Ingest Owner from source. Be careful: This cah override Owners added by users of NuoData.',
    type: FieldType.BOOLEAN,
...
export const START_TIME: RecipeField = {
    ...
    label: 'Start Time',
    tooltip:
        'Earliest date used when processing audit logs for lineage, usage, and more. Default: Last full day in UTC or last time NuoData ingested usage (if stateful ingestion is enabled). Tip: Set this to an older date (e.g. 1 month ago) to bootstrap your first ingestion run, and then reduce for subsequent runs. Changing this may increase the duration of the extraction process.',
